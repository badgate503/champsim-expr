...
compile_command = {
    ...
    "pcq-1": f"python3 compiler.py -p pctp -f INDEPENDENT_PAT INF_PAT PCQ_SIZE=1 -e pcq-1",
    "pcq-2": f"python3 compiler.py -p pctp -f INDEPENDENT_PAT INF_PAT PCQ_SIZE=2 -e pcq-2",
    "pcq-4": f"python3 compiler.py -p pctp -f INDEPENDENT_PAT INF_PAT PCQ_SIZE=4 -e pcq-4",
    "pcq-8": f"python3 compiler.py -p pctp -f INDEPENDENT_PAT INF_PAT PCQ_SIZE=8 -e pcq-8",
    "pcq-12": f"python3 compiler.py -p pctp -f INDEPENDENT_PAT INF_PAT PCQ_SIZE=12 -e pcq-12",
    "pcq-16": f"python3 compiler.py -p pctp -f INDEPENDENT_PAT INF_PAT PCQ_SIZE=16 -e pcq-16",

    "pat-12k": f"python3 compiler.py -p pctp -f INDEPENDENT_PAT PAT_SIZE=12*1024 -e pat-12k",
    "pat-24k": f"python3 compiler.py -p pctp -f INDEPENDENT_PAT PAT_SIZE=24*1024 -e pat-24k",
    "pat-48k": f"python3 compiler.py -p pctp -f INDEPENDENT_PAT PAT_SIZE=48*1024 -e pat-48k",
    "pat-96k": f"python3 compiler.py -p pctp -f INDEPENDENT_PAT PAT_SIZE=96*1024 -e pat-96k",
    "pat-144k": f"python3 compiler.py -p pctp -f INDEPENDENT_PAT PAT_SIZE=144*1024 -e pat-144k",
    "pat-192k": f"python3 compiler.py -p pctp -f INDEPENDENT_PAT PAT_SIZE=192*1024 -e pat-192k",
